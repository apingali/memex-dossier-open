...
.. This software is released under an MIT/X11 open source license.
   Unpublished work copyright 2012-2017 Diffeo, Inc.

memex_dossier.web.routes is a REST stateful web service that can
drive Memex_Dossier Stack's an active ranking models and user interface, as
...
To that end, ``memex_dossier.web`` exposes a set of web service endpoints
for managing folders and subfolders for a particular user. Folders and
subfolders are stored and managed by :mod:`memex_dossier.label`, which means
...
from memex_dossier.web import util
import yakonfig
