...
from memex_dossier.web.tags import TagsSync
import memex_dossier.web.tags as tag_routes
from memex_dossier.web.tests.test_routes import new_request
import pytest


NAMESPACE = 'memex_dossier_web_tests'
DUMMY_ASSOC = {
