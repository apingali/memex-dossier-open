'''A builder for constructing Memex Dossier Stack web applications.
...
from memex_dossier.web import search_engines as builtin_engines
from memex_dossier.web.config import Config
from memex_dossier.web.filters import already_labeled
from memex_dossier.web.routes import app as default_app
from memex_dossier.web.tags import app as tags_app
...
class WebBuilder(object):
    ...
    Memex Dossier Stack web services have a lot of knobs, so instead of a single
    ...
    def add_search_engine(self, name, engine):
        ...
        :class:`memex_dossier.web.SearchEngine`, which should provide a means
    ...
    def add_filter(self, name, filter):
        ...
        an instance. The class *must* be a subclass of
        :class:`memex_dossier.web.Filter`, which should provide a means
