...
from memex_dossier.web.tags import Tags
import kvlayer
import yakonfig
...
class Config(yakonfig.factory.AutoFactory):
    '''Configuration for memex_dossier.web.

    .. automethod:: memex_dossier.web.Config.create
    .. autoattribute:: memex_dossier.web.Config.kvlclient
    .. autoattribute:: memex_dossier.web.Config.store
    .. autoattribute:: memex_dossier.web.Config.label_store
    '''
    ...
    @safe_service('_tags')
    def tags(self):
        'Return a thread local :class:`memex_dossier.web.Tags` client.'
        if self._tags is None:
            config = global_config('memex_dossier.tags')
    ...
    @safe_service('_store')
    def store(self):
        '''Return a thread local :class:`memex_dossier.store.Store` client.'''
        raise NotImplementedError
        if self._store is None:
            config = global_config('memex_dossier.store')
