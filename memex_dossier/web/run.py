'''memex_dossier.web.run

.. This software is released under an MIT/X11 open source license.
   Copyright 2012-2014 Diffeo, Inc.

This is the "main" function of ``memex_dossier.web``. Generally, you won't use
it directly, but instead import ``get_application`` from ``memex_dossier.web``
