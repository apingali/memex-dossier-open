'''
Tagging for Memex Dossier Stack
=========================
...
@app.get('/dossier/v0/tags/associations/url/<url:path>')
...
class Tags(object):
    config_name = 'memex_dossier.tags'

    @classmethod
    def configured(cls):
        return cls(**yakonfig.get_global_config('memex_dossier.tags'))

    def __init__(self, hosts=None, namespace=None, type_prefix='',
                 shards=None, tag_delimiter='/'):
        if hosts is None:
