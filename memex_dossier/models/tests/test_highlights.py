...
from memex_dossier.models.tests import kvl
from memex_dossier.models.tests.test_web import tfidf, tfidf_path
from memex_dossier.models.web.routes import make_xpath_ranges, \
    highlights_worker, \
...
class MockTaskMaster(object):
    def __init__(self, kvl, tfidf_path):
        self.config = {
            'kvlayer': kvl._config,
            'memex_dossier.models': {'tfidf_path': tfidf_path},
            }
